...
import com.mieso.app.ui.admin.* // Import semua screen dari package admin
...
fun AppNavigation(navController: NavHostController) {
    NavHost(
        ...
        composable(Screen.DeliveryDetails.route) { DeliveryDetailsScreen(navController = navController) }
        ...
        composable(Screen.AdminManageOrders.route) {
            // Ini akan memanggil Composable yang akan kita buat di langkah selanjutnya
            AdminManageOrdersScreen(navController = navController)
        }
